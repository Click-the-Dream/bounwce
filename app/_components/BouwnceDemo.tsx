...
const BouwnceDemo = () => {
  ...
  return (
    <div
      ...
      className="relative w-full h-95 bg-white rounded-3xl border border-gray-200 overflow-hidden font-sans text-sm shadow-2xl mx-auto select-none flex flex-col items-center justify-center"
    >
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M8.52914 9.28813V6.80788C8.52914 6.65941 8.4085 6.53906 8.25969 6.53906C8.11087 6.53906 7.99023 6.65941 7.99023 6.80788V9.28813C7.99023 9.43659 8.11087 9.55694 8.25969 9.55694C8.4085 9.55694 8.52914 9.43659 8.52914 9.28813Z"
            fill="black"
          />
          <path
            d="M7.10698 9.28722L7.09261 6.80569C7.09176 6.65759 6.97042 6.53821 6.82161 6.53907C6.6728 6.53992 6.55286 6.66068 6.55372 6.80878L6.56809 9.29031C6.56894 9.43842 6.69028 9.55779 6.83909 9.55694C6.9879 9.55608 7.10784 9.43533 7.10698 9.28722Z"
            fill="black"
          />
          <path
            d="M5.11622 6.81138L5.13059 9.28778C5.13145 9.4373 5.25279 9.55781 5.40161 9.55694C5.55042 9.55606 5.67035 9.43414 5.66948 9.28462L5.65511 6.80823C5.65425 6.6587 5.53291 6.5382 5.38409 6.53907C5.23528 6.53994 5.11535 6.66186 5.11622 6.81138Z"
            fill="black"
          />
        </svg>
      </motion.div>
      ...
      <div className="flex w-full h-full">
        {/* Sidebar */}
        <div
          className={`border-r-[0.53px] border-[#D6D6D6] bg-[#FAFAFA] transition-all duration-500 shrink-0 ${step === 0 ? "w-52" : "w-14"}`}
        >
        ...
        `}
            ...
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className="bg-[#F3F3F3] opacity-60 mx-auto p-2 h-5 w-full rounded-[3px]"
              />
            ))}
          </div>
        </div>
            ...
            >
              ...
              {step === 1 && (
                <motion.div
                  ...
                  className="h-full"
                >
                  <h1 className="text-[9px] text-[#8A8A8A] mb-1 font-medium p-2">
                    Application / <span className="text-black">Category</span>
                  </h1>
                  <p className="text-[#8A8A8A] text-[9px] mb-5 font-medium px-2">
                    Click on preferred category
                  </p>

                  <div className="space-y-1">
                    <div className="grid grid-cols-3 text-[6px] md:text-[9px] font-medium uppercase tracking-widest text-black border-b-[0.53px] border-[#DBDBDB] bg-[#FAFAFA] mb-2">
                      <span className="px-3 py-1">Name</span>
                      <span className="px-3 py-1">Users</span>
                      <span className="text-right px-3 py-1">Action</span>
                    </div>
                    <CategoryRow
                      name="Communication"
              ...
              {step === 2 && (
                ...
                >
                  ...
                  <div className="space-y-1">
                    <div className="grid grid-cols-3 text-[6px] font-medium md:text-[9px] uppercase tracking-widest text-black border-b-[0.53px] border-[#DBDBDB] bg-[#FAFAFA] mb-2">
                      <span className="px-3 py-1">Application</span>
                      <span className="px-3 py-1">URL</span>
                      <span className="text-right px-3 py-1">Status</span>
                    </div>
                    <AppRow
                      name="Google"
                      url="www.google.com"
                      icon={
                        ...
                        >
                          <path
                            ...
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M4.41041 0.0434101C4.947 -0.01447 5.26452 -0.01447 5.84108 0.0434101C6.86166 0.18925 7.80775 0.64471 8.54254 1.34393C8.04601 1.79706 7.55599 2.25681 7.07265 2.72305C6.147 1.9656 5.11378 1.79077 3.973 2.19855C3.13616 2.57013 2.55343 3.17227 2.22481 4.00499C1.68781 3.619 1.1578 3.22402 0.635022 2.82023C0.598691 2.80177 0.557196 2.79501 0.516602 2.80094C1.34702 1.25508 2.64471 0.335669 4.40967 0.0426955"
                            fill="#F44336"
                          />
                          <path
                            opacity="0.997"
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M0.515315 2.80306C0.557256 2.79687 0.596976 2.8033 0.634476 2.82235C1.15725 3.22614 1.68726 3.62112 2.22427 4.00711C2.13976 4.33157 2.0865 4.66287 2.06514 4.99679C2.0834 5.31978 2.13644 5.63681 2.22427 5.94788L0.555282 7.23054C-0.171523 5.76424 -0.184845 4.28841 0.515315 2.80306Z"
                            fill="#FFC107"
                          />
                          <path
                            opacity="0.999"
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M8.46314 8.78263C7.94347 8.34016 7.39942 7.9251 6.83338 7.53928C7.40081 7.15246 7.74521 6.62177 7.8666 5.94722H5.08594V4.0829C6.68955 4.07004 8.29242 4.08314 9.89454 4.12221C10.1985 5.7157 9.84742 7.15246 8.84134 8.43249C8.72171 8.55527 8.59499 8.67213 8.46314 8.78263Z"
                            fill="#448AFF"
                          />
                          <path
                            opacity="0.993"
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M2.22367 5.94531C2.83058 7.40161 3.94324 8.0814 5.56165 7.9847C6.01596 7.93392 6.45154 7.78069 6.83319 7.53737C7.39963 7.9242 7.94288 8.33865 8.46295 8.78073C7.63892 9.49562 6.58829 9.9198 5.48245 9.98406C5.23121 10.0035 4.97877 10.0035 4.72752 9.98406C2.84365 9.76969 1.45271 8.85075 0.554688 7.22725L2.22367 5.94531Z"
                            fill="#43A047"
                          />
                        </svg>
                      }
                    ...
                    <AppRow
                      ...
                      icon={
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <g clipPath="url(#clip0_8275_621)">
                            <path
                              d="M2.12891 6.30602C2.12891 6.87867 1.66188 7.34641 1.08914 7.34641C0.516406 7.34641 0.0488281 6.87867 0.0488281 6.30602C0.0488281 5.73336 0.516562 5.26562 1.08922 5.26562H2.12898L2.12891 6.30602ZM2.65305 6.30602C2.65305 5.73336 3.12078 5.26562 3.69344 5.26562C4.26609 5.26562 4.73383 5.73328 4.73383 6.30602V8.91031C4.73383 9.48297 4.26617 9.9507 3.69344 9.9507C3.12078 9.9507 2.65305 9.48297 2.65305 8.91031V6.30602Z"
                              fill="#DE1C59"
                            />
                            <path
                              d="M3.69344 2.13086C3.12078 2.13086 2.65305 1.66383 2.65305 1.09109C2.65305 0.518359 3.12078 0.0507812 3.69344 0.0507812C4.26609 0.0507812 4.73383 0.518516 4.73383 1.09117V2.13094L3.69344 2.13086ZM3.69344 2.655C4.26609 2.655 4.73383 3.12273 4.73383 3.69539C4.73383 4.26805 4.26617 4.73578 3.69344 4.73578H1.08914C0.516484 4.73578 0.0488281 4.26812 0.0488281 3.69539C0.0488281 3.12273 0.516562 2.655 1.08922 2.655H3.69344Z"
                              fill="#35C5F0"
                            />
                            <path
                              d="M7.87055 3.69539C7.87055 3.12273 8.33758 2.655 8.91031 2.655C9.48305 2.655 9.9507 3.12273 9.9507 3.69539C9.9507 4.26805 9.48297 4.73578 8.91031 4.73578H7.87055V3.69539ZM7.34641 3.69539C7.34641 4.26805 6.87867 4.73578 6.30602 4.73578C5.73336 4.73578 5.26562 4.26812 5.26562 3.69539V1.09109C5.26563 0.518438 5.73328 0.0507812 6.30602 0.0507812C6.87867 0.0507812 7.34641 0.518516 7.34641 1.09117V3.69539Z"
                              fill="#2EB57D"
                            />
                            <path
                              d="M6.30602 7.87055C6.87867 7.87055 7.34641 8.33758 7.34641 8.91031C7.34641 9.48305 6.87867 9.9507 6.30602 9.9507C5.73336 9.9507 5.26562 9.48297 5.26562 8.91031V7.87055H6.30602ZM6.30602 7.34641C5.73336 7.34641 5.26562 6.87867 5.26562 6.30602C5.26562 5.73336 5.73328 5.26562 6.30602 5.26562H8.91031C9.48297 5.26562 9.9507 5.73328 9.9507 6.30602C9.9507 6.87867 9.48297 7.34641 8.91031 7.34641H6.30602Z"
                              fill="#EBB02E"
                            />
                          </g>
                          <defs>
                    ...
                    <AppRow
                      ...
                      icon={
                        ...
                        >
                          <path
                            d="M2.41375 2.31675C3.56608 2.31675 7.05454 2.19986 8.11569 2.8513C9.08313 3.44523 9.63004 4.33564 9.87971 5.36482C10.1294 6.394 9.98788 7.47031 9.47858 8.41598C8.96928 9.36165 8.12264 10.1201 7.07851 10.5661C6.03437 11.0121 4.85518 11.1189 3.73572 10.8689C2.61625 10.6189 1.62346 10.0271 0.921326 9.1912C0.219192 8.35528 -0.00389161 7.36314 0.0203041 6.30915C0.0203806 5.18728 0.0203204 5.62281 0.0616356 4.17107H2.30497C2.30497 4.67249 2.26323 5.74634 2.30497 6.32894C2.35224 6.98888 2.41375 7.56818 2.74333 7.95893C3.21081 8.51317 3.65118 8.723 4.27129 8.86147C4.89141 8.99994 5.5446 8.94077 6.12299 8.69372C6.70138 8.44668 7.17036 8.02654 7.45249 7.50269C7.73461 6.97885 7.81299 6.38264 7.67468 5.81254C7.53638 5.24244 7.25118 4.77162 6.69541 4.43507C6.16024 4.09852 3.05207 4.17107 2.41375 4.17107V2.31675Z"
                            fill="black"
                          />
                          <rect
                            width="2.38772"
              ...
              {step === 4 && <DemoLoading key="loading" />}
            </motion.div>
          </AnimatePresence>
        </div>
      </div>
...
const CategoryRow = ({
  ...
  <div
    className={`grid grid-cols-3 items-center p-1 px-3 transition-all duration-200 border ${active ? "bg-[#FFE9E5] border-[#FF4B2B] shadow-sm" : "border-transparent"}`}
  >
    <div className="flex items-center gap-3">
      <div
        className={`${color} w-5 h-5 rounded-full flex items-center justify-center text-[6px] md:text-[9px] font-black uppercase shadow-sm`}
      >
        {char}
      </div>
    ...
    {name === "Socials" ? (
      <div className="flex -space-x-2">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="w-6 h-6 rounded-full border-2 border-white bg-gray-200 shadow-sm"
          />
        ))}
      </div>
    ) : (
...
const AppRow = ({
  ...
  >
    <div className="flex items-center gap-3">
      <div className="rounded-full flex items-center justify-center text-white text-[6px] md:text-[9px] font-black">
        {icon}
      </div>
      <span className="text-[#8A8A8A] text-[6px] md:text-[9px]">{name}</span>
    </div>
    <span className="text-[#8A8A8A] text-[6px] md:text-[9px] font-medium truncate pr-4">
      {url}
    </span>
