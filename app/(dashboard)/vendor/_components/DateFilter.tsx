...
function cx(...args: (string | boolean)[]) {
  return args.filter(Boolean).join(" ");
}

export default function DateFilter({ value, onChange, className }: any) {
  ...
  const selectRangeDay = (day: string | number | Date) => {
            ...
            <div className="border-t border-gray-200 p-3 md:border-t-0 md:border-l">
              ...
              <div className="mb-2 flex items-center justify-between">
                <button
                  ...
                  onClick={() => setMonthCursor((d: any) => subMonths(d, 1))}
                ...
                <button
                  className="rounded-md p-1.5 hover:bg-gray-100"
                  onClick={() => setMonthCursor((d: any) => addMonths(d, 1))}
