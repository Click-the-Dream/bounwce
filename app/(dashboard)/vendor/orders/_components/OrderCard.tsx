import { statusStyles } from "@/app/_utils/formatters";
...
const OrderCard = ({ order }: any) => {
  ...
  return (
    <>
      ...
      <div className="border-[0.53px] border-[#0000001A] rounded-xl bg-white mb-3 py-3">
          ...
          <div className="space-y-1.5 w-full">
            ...
            <section className="flex items-center justify-between gap-2  w-full border-b border-[#0000001A] pb-2 mb-2 px-5">
              ...
              <div className="flex flex-wrap items-center gap-2 md:gap-3">
                ...
                {hasStatus && (
                  <span
                    className={`px-1.5 py-0.5 text-[9px] md:text-[10px] rounded-lg text-center ${
                ...
                {order.tag && (
                  <span className="px-2 py-0.5 text-[9px] md:text-[10px] rounded-lg bg-[#FFE5E5] text-[#FF0000]">
                    {order.tag}
                  </span>
                )}
              </div>
