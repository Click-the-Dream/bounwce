...
import { itemVariants, steps } from "@/app/_utils/formatters";

const ProgressStep = ({ currentStep }: { currentStep: number }) => {
  return (
    <motion.div
    ...
    >
      <div className="flex flex-col justify-between items-center mb-4">
        ...
        <div className="w-full flex items-center gap-2 justify-between mb-4">
          ...
          <div
            className={`blobk md:hidden flex-1 h-0.5 mx-2 bg-gray-300 transition-colors duration-300`}
          ></div>
