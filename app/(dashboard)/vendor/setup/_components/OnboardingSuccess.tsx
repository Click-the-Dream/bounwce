...
const OnboardingSuccess = ({ storeData }: any) => {
  ...
  const averagePrice = useMemo(() => {
    ...
    const total = products.reduce(
      (sum: number, product: { amount: string }) => {
    ...
    <div className="">
      ...
      <div className="text-center mb-10 border border-gray-300 bg-white p-6 sm:p-8 rounded-2xl">
        ...
        <div className="mt-4 flex flex-col justify-center items-center">
          <div className="flex items-center gap-2 px-4 py-2">
            ...
            <span className="inline-block text-[10px] text-gray-100 bg-[#92922e] border-[#9F9F9F] px-3 py-0.5 rounded-2xl">
              Draft
            </span>
          </div>
      ...
      <div className="flex flex-wrap justify-between items-center gap-3 mt-8 text-sm">
        ...
        <div className="ml-auto flex flex-wrap gap-3">
          <button
            onClick={() => router.replace("/vendorStore")}
