      ...
      <div className="flex flex-wrap justify-between gap-2 pt-6 text-sm">
        {currentTab !== "store" && (
          <button
            ...
            className={`cursor-pointer flex gap-2 items-center px-4 py-2 border-[0.5px] border-[#0000001A] rounded-md text-gray-700 transition-colors disabled:opacity-50 ${
              currentTab === "store"
