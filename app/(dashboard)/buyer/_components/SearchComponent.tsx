...
const SearchComponent = () => {
  ...
  return (
    ...
    >
      ...
      {/* --- DROPDOWN RESULTS --- */}
      {isFocused && (
        <div className="absolute top-0 left-0 w-full max-h-109.75 pt-10 bg-white border border-gray-200 rounded-xl shadow-2xl z-10 overflow-hidden min-h-112.5 transition-all duration-200">
