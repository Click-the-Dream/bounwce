      ...
      {isLoading ? (
        <div className="flex items-center justify-center gap-3 text-sm text-gray-300">
          <div className="relative">
            <div className="w-2.5 h-2.5 bg-linear-to-r from-orange to-amber-500 rounded-full animate-pulse"></div>
            <div className="absolute inset-0 w-2.5 h-2.5 bg-linear-to-r from-orange to-amber-500 rounded-full animate-ping"></div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-center gap-6">
            ...
            <div className="flex flex-wrap items-center gap-3 group">
              <div className="relative">
                <div className="w-10 h-10 rounded-xl bg-linear-to-br from-orange/50 md:from-orange/20 to-amber-600/50 md:to-amber-600/20 border border-orange/30 flex items-center justify-center backdrop-blur-sm">
                  <Users className="h-4 w-4 text-orange-300" />
                </div>
                <div className="absolute -inset-1 bg-linear-to-r from-orange to-amber-500 rounded-xl opacity-0 group-hover:opacity-20 blur transition-all duration-500"></div>
              </div>
              <div className="text-left">
                <div className="flex items-baseline gap-1">
                  <span
                    className={`text-2xl font-light bg-clip-text text-transparent ${!hideAnalytics ? "bg-linear-to-br from-white to-gray-300" : "bg-linear-to-br from-gray-400 to-gray-700"}`}
                  >
                    {animatedCount}
                  </span>
            ...
            {/* Divider */}
            <div className="w-px h-8 bg-linear-to-b from-transparent via-gray-600/60 to-transparent"></div>
            ...
            <div className="space-y-3">
              ...
              <div className="w-56 mx-auto h-0.5 bg-gray-800 rounded-full overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-linear-to-r from-orange to-amber-500 rounded-full"
                />
              </div>

              <p className="text-xs text-gray-400 text-center font-light tracking-wider">
                Join early to secure{" "}
                <span className="text-orange">priority access</span> and unlock
                campus-exclusive benefits.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="flex items-center justify-center gap-3 text-sm text-gray-300">
          <div className="relative">
            <div className="w-6 h-6 rounded-full bg-linear-to-br from-orange to-amber-500 flex items-center justify-center">
