...
const BouwnceDemo = () => {
    ...
    return (
        <div className="relative max-w-[450px] h-[400px] bg-white rounded-3xl border border-gray-200 overflow-hidden font-sans text-sm shadow-2xl mx-auto select-none flex flex-col items-center justify-center">
