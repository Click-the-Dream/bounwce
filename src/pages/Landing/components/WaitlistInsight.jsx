...
const WaitlistInsight = ({ isLoading, joinedCount, animatedCount, progressPercent, waitlistData, hideAnalytics }) => {
    return (
        <motion.div
            ...
            viewport={{ amount: 0.4 }}
            className={`pt-10 md:absolute md:bottom-10 md:left-0 md:right-0 md:bg-black/40 md:text-white fixed bottom-0 left-0 right-0 z-50 bg-white text-black  h-max w-full max-w-sm mx-auto text-center px-6`}
        >
            {isLoading ? (
