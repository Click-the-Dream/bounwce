    ...
    <footer className="w-full py-10 lg:py-12 bg-white ">
      <div className="w-[90%] max-w-[1000px] mx-auto flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col md:flex-row justify-center md:justify-between md:items-center gap-4 w-full">
          ...
          <ul className="flex flex-wrap justify-center md:justify-end items-center gap-3 text-black font-medium">
            {navLinks.map((link) => (
              <li key={link.name}>
                <Link
                  to={link.path}
          ...
          {socialLinks.map((link) => {
            ...
            return (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-[#8C857B] hover:text-brand-orange brand-orange hover:-translate-y-1 transition-all duration-300"
